...
final exercisesSelection = [
  for (final exercise in listExercisesChest)
    Exercise(name: exercise, groups: Groups.chest),
  for (final exercise in listExercisesShoulder)
    Exercise(name: exercise, groups: Groups.shoulder),
  for (final exercise in listExercisesBiceps)
    Exercise(name: exercise, groups: Groups.biceps),
  for (final exercise in listExercisesTriceps)
    Exercise(name: exercise, groups: Groups.triceps),
  for (final exercise in listExercisesBack)
    Exercise(name: exercise, groups: Groups.back),
  for (final exercise in listExercisesLegs)
    Exercise(name: exercise, groups: Groups.legs),
  for (final exercise in listExercisesGlutes)
    Exercise(name: exercise, groups: Groups.glutes),
  for (final exercise in listExercisesAbs)
    Exercise(name: exercise, groups: Groups.abs),
];
